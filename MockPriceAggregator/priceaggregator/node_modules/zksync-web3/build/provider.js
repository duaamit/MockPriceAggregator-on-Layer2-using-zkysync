...
class Provider extends ethers_1.ethers.providers.JsonRpcProvider {
    ...
    async getL2ToL1MessageProof(blockNumber, sender, msg) {
        const hashedMessage = ethers_1.ethers.utils.keccak256(msg);
        const proof = await this.send('zks_getL2ToL1MsgProof', [blockNumber, sender, hashedMessage]);
        return proof;
    }
