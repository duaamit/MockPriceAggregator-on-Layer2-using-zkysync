...
declare const Wallet_base: {
    new (...args: any[]): {
        ...
        getL2BridgeContracts(): Promise<{
            eth: import("zksync-web3/build/typechain").IL2Bridge;
    ...
    new (...args: any[]): {
        ...
        getL1BridgeContracts(): Promise<{
            eth: import("zksync-web3/build/typechain").IL1Bridge;
        ...
        getBaseCost(params: {
            ...
            queueType?: import("zksync-web3/build/src/types").PriorityQueueType;
